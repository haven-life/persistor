...
module.exports = function (PersistObjectTemplate, baseClassForPersist) {
    ...
    PersistObjectTemplate._injectTemplateFunctions = function (template) {
        ...
        template.deleteFromPersistWithQuery = function(query, txn, logger) {
            ...
            return deleteQuery.catch(e => logExceptionAndRethrow(e, logger || PersistObjectTemplate.logger, template.__name__, query, 'deleteFromPersistWithQuery'));
        };
        ...
        template.persistorDeleteByQuery = function(query, options) {
            ...
            return deleteQuery.catch(e => logExceptionAndRethrow(e, options.logger || PersistObjectTemplate.logger, template.__name__, query, 'persistorDeleteByQuery'));
        };
