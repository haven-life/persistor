...
module.exports = function (PersistObjectTemplate, baseClassForPersist) {
    ...
    PersistObjectTemplate._injectTemplateFunctions = function (template) {
        ...
        function logErrorAndRethrow(e, logger) {
            (logger || PersistObjectTemplate.logger).error({
                component: 'persistor', module: 'db.getFromPersistWithQuery',
                data: {template: template.__name__, params: query}
            });
            throw e;
        }
        ...
        template.getFromPersistWithId = function(id, cascade, isTransient, idMap, isRefresh, logger) {
            ...
            return (dbType == PersistObjectTemplate.DB_Mongo ?
                ...
                .catch(logErrorAndRethrow.bind(e, logger));
        };
        ...
        template.getFromPersistWithQuery = function(query, cascade, start, limit, isTransient, idMap, options, logger) {
            ...
            return getQuery.catch(logErrorAndRethrow.bind(logger));
        };
        ...
        template.deleteFromPersistWithQuery = function(query, txn, logger) {
            ...
            return deleteQuery.catch(logErrorAndRethrow.bind(logger));
        };
        ...
        template.persistorFetchById = function(id, options) { // @TODO: Legacy
            ...
            var dbType = persistObjectTemplate.getDB(persistObjectTemplate.getDBAlias(template.__collection__)).type;
            let resultsQuery = (dbType == persistObjectTemplate.DB_Mongo ?
            ...
            return resultsQuery.catch(logErrorAndRethrow.bind(options.logger || persistObjectTemplate.logger));
        };
        ...
        template.persistorCountByQuery = function(query, options) {
            ...
            return countQuery.catch(logErrorAndRethrow.bind(options.logger || PersistObjectTemplate.logger));
        };
        ...
        template.deleteFromPersistWithId = function(id, txn, logger) {
            ...
            return deleteQuery.catch(logErrorAndRethrow.bind(logger || PersistObjectTemplate.logger));
        };
        ...
        template.countFromPersistWithQuery = function(query, logger) {
            ...
            return countQuery.catch(logErrorAndRethrow.bind(logger || PersistObjectTemplate.logger));
        };
