...
export namespace Schema {
    ...
    export function setSchema(persistor, schema) {
        persistor._schema = schema;
    }

    export function appendSchema(persistor, schema) {
     ...
     */
    export function _verifySchema(persistor) {
    ...
    export function isCrossDocRef(template, prop, defineProperty) {
