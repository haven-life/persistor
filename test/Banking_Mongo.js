...
var Mongo = require('../dist/lib/Mongo.js').Mongo;
var writing = true;
/*
...
describe('Banking Example', function () {
    ...
    it('calling getTemplateFromPOJO without idmap should raise an error', function() {
        console.log(Mongo.getTemplateFromPOJO);
        expect(Mongo.getTemplateFromPOJO.bind(this, PersistObjectTemplate)).to.throw(/missing idMap on getTemplateFromMongoPOJO/);
    });

    it('calling savePojoToMongo directly', function() {
        var custForSavePojo = new Customer();
        Mongo.save(PersistObjectTemplate, custForSavePojo, {
    ...
    it('calling savePojoToMongo with null as pojo, ', function() {
        ...
        return Mongo.save(PersistObjectTemplate, custForSavePojo, {
            'firstName': 'custForSavePojo',
            'lastName': 'lastName'
        }).then(function () {
            return Mongo.save(PersistObjectTemplate, custForSavePojo, {
    ...
    it('distinctFromMongoQuery coverage', function () {
        Mongo.distinctByQuery(PersistObjectTemplate, Customer, 'firstName', {_id: PersistObjectTemplate.ObjectID(sam._id.toString())}).then(function(customers) {
    ...
    it('getPOJOFromMongoId coverage', function () {
        Mongo.getPOJOById(PersistObjectTemplate, Customer, sam._id).then (function (customer) {
            expect(customer.firstName).to.equal('Sam');
        }).catch(function(e) {
            throw e;
        });
    ...
    it('getPOJOFromMongoId should return null', function () {
        Mongo.getPOJOById(PersistObjectTemplate, Customer, '5841ea4e0579b824807ab48b').then (function (customer) {
