...
var Knex = requireUncached('../../../../dist/lib/Knex.js').Knex;
...
describe('persistor transaction checks', function () {
    ...
    before('arrange', function () {
        ObjectTemplate = requireUncached('supertype').default;
        PersistObjectTemplate = requireUncached('../../../../dist/index.js').default(ObjectTemplate);
